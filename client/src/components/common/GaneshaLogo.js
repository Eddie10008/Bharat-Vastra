  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      <div className={`${sizeClasses[size]} relative`}>
        ...
        >
          {/* Concentric circles - mandala structure */}
          ...
          {/* Ganesha figure - detailed with all attributes */}
          ...
          {/* Geometric nodes - different sizes */}
